import type { FacetGradientColor, PlayerColors } from '@/types/statistic/match-details';
import type { Player, HeroList, PlayerProfile } from '@/types/statistic/match-data';
import type {
  HeroDetails,
  PlayerDetails,
  Items,
  ItemDetails,
  UPlayerRowDetails,
} from '@/types/statistic/player-row';
